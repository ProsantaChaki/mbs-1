				...
				<table id="deposit_Table" name="table_records" class="table table-bordered  responsive-utilities jambo_table table-striped  table-scroll ">
					<thead >
						<tr class="headings">
							...
							<th class="column-title text-right" width="40%">Withdrown Amount (€)</th>							
						</tr>
					</thead>
				...
				<form id="deposit_form" name="deposit_form" enctype="multipart/form-data" class="form-horizontal form-label-left">   
					...
					<div class="form-group">
						...
						<div class="col-md-6 col-sm-6 col-xs-12">  
							...
							<button type="submit" id="saveBtn" class="btn btn-success">Withdrow</button>                    
			...
			$.ajax({
				...
				success: function(data){
					if(data==1){
						...
						success_or_error_msg('#form_submit_error',"danger","Blanace less than requested amount");																			
					}
					else{
